...
\date{May 2026 (revised August 2026, reflecting sqz 1.4.0)}
...
Future directions include wiring the existing MinHash LSH primitive~\cite{minhash2025} into sub-file dedup, integration with KV cache compression methods~\cite{chen2025codecomp}, and learned formatters that adapt to project-specific output patterns.
